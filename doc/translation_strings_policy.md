...
This document provides guidelines for internationalization of the MagnaChain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `magnachain_en.ts` remains unchanged.
