MagnaChain Core version 0.10.4 is now available from:

  <https://magnachain.org/bin/magnachain-core-0.10.4/>
...
- #6953 `43c2789` Split magnachain-tx into its own package
- #6953 `dfe0d4d` Include magnachain-tx binary on Debian/Ubuntu
