MagnaChain Core version 0.9.4 is now available from:

  https://magnachain.org/bin/0.9.4/
...
this update is incompatible with the MagnaChain system and could lead to consensus
forks.

MagnaChain Core released binaries from https://magnachain.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~magnachain/+archive/ubuntu/magnachain
- A third-party or self-compiled MagnaChain Core

upgrade to MagnaChain Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
