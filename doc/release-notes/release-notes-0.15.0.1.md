MagnaChain Core version *0.15.0.1* is now available from:

  <https://magnachain.org/bin/magnachain-core-0.15.0.1/>

and

  <https://magnachaincore.org/bin/magnachain-core-0.15.0.1/>
