MagnaChain-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/magnachain/files/MagnaChain/magnachain-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the MagnaChain
...
New/changed settings (command-line or magnachain.conf file)
--------------------------------------------------------
