MagnaChain Core version 0.13.2 is now available from:

  <https://magnachain.org/bin/magnachain-core-0.13.2/>
...
- #8908 `4a974b2` Update magnachain-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow magnachain-tx to create v2 transactions (btcdrak)
