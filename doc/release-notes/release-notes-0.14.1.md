MagnaChain Core version 0.14.1 is now available from:

  <https://magnachain.org/bin/magnachain-core-0.14.1/>
...
here:
[reducing-magnachaind-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` magnachain-tx input verification (awemany, jnewbery)
