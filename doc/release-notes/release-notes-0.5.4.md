MagnaChain version 0.5.4 is now available for download at:
http://sourceforge.net/projects/magnachain/files/MagnaChain/magnachain-0.5.4/
...
http://gitorious.org/magnachain/magnachaind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix MagnaChain-Qt notifications under Growl 1.3.
Increase required age of MagnaChain-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMagnaChain properly when installing MagnaChain-Qt over it. (Windows)
