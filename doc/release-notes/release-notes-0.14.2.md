MagnaChain Core version 0.14.2 is now available from:

  <https://magnachain.org/bin/magnachain-core-0.14.2/>
...
(in MagnaChain Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in MagnaChain-Qt when using coin
...
- #10228 `ae479bc` Regenerate magnachain-config.h as necessary (theuni)
