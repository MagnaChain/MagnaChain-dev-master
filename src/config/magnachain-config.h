/* src/config/magnachain-config.h.  Generated from magnachain-config.h.in by configure.  */
...
#define PACKAGE_BUGREPORT "https://github.com/MagnaChainIO"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MagnaChain Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MagnaChain Core 0.26.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "magnachain"

/* Define to the home page for this package. */
#define PACKAGE_URL "http://www.magnachain.io/"
