...
static const unsigned int DEFAULT_DESCENDANT_LIMIT = 50;
...
bool CheckBlock(const CellBlock& block, CellValidationState& state, const Consensus::Params& consensusParams, bool fCheckPOW = true, bool fCheckMerkleRoot = true, bool fVerifingDB = false, BranchCache *pBranchCache = nullptr);
