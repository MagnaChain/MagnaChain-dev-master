...
{
    return QCoreApplication::translate("magnachain-core", psz).toStdString();
}
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. magnachain_de.qm (shortcut "de" needs to be defined in magnachain.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. magnachain_de_DE.qm (shortcut "de_DE" needs to be defined in magnachain.qrc)
...
void MagnaChainApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // magnachain: URIs or payment requests:
...
int main(int argc, char *argv[])
{
    ...
    /// 6. Determine availability of data directory and parse magnachain.conf
    ...
    try {
        ...
        QMessageBox::critical(0, QApplication::translate("magnachain-core", PACKAGE_NAME), QObject::tr("Error: %1").arg(e.what()));
        return EXIT_FAILURE;
    }
#ifdef ENABLE_WALLET
    ...
    // magnachain: links repeatedly have their payment requests routed to this process:
