...
<context>
    ...
    <message>
        ...
        <translation>К magnachain: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть CellLink.</translation>
    </message>
    <message>
        <source>Pay To:</source>
