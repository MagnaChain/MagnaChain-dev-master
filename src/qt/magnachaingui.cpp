    ...
    platformStyle(_platformStyle)
{
    ...
    QString windowTitle = QApplication::translate("magnachain-core", PACKAGE_NAME) + " - ";
#ifdef ENABLE_WALLET
...
void MagnaChainGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and magnachain: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About %1").arg(QApplication::translate("magnachain-core", PACKAGE_NAME)), this);
    aboutAction->setStatusTip(tr("Show information about %1").arg(QApplication::translate("magnachain-core", PACKAGE_NAME)));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for %1").arg(QApplication::translate("magnachain-core", PACKAGE_NAME)));
    ...
    openAction->setStatusTip(tr("Open a magnachain: URI or payment request"));
...
void MagnaChainGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("%1 client").arg(QApplication::translate("magnachain-core", PACKAGE_NAME)) + " " + networkStyle->getTitleAddText();
