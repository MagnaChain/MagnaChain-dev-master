    ...
    platformStyle(_platformStyle)
{
    ...
    QString windowTitle = QApplication::translate("celllink-core", PACKAGE_NAME) + " - ";
#ifdef ENABLE_WALLET
...
void CellLinkGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and celllink: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About %1").arg(QApplication::translate("celllink-core", PACKAGE_NAME)), this);
    aboutAction->setStatusTip(tr("Show information about %1").arg(QApplication::translate("celllink-core", PACKAGE_NAME)));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for %1").arg(QApplication::translate("celllink-core", PACKAGE_NAME)));
    ...
    openAction->setStatusTip(tr("Open a celllink: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible CellLink command-line options").arg(QApplication::translate("celllink-core", PACKAGE_NAME)));
...
void CellLinkGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("%1 client").arg(QApplication::translate("celllink-core", PACKAGE_NAME)) + " " + networkStyle->getTitleAddText();
