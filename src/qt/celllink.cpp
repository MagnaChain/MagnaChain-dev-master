...
{
    return QCoreApplication::translate("celllink-core", psz).toStdString();
}
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. celllink_de.qm (shortcut "de" needs to be defined in celllink.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. celllink_de_DE.qm (shortcut "de_DE" needs to be defined in celllink.qrc)
...
/** Class encapsulating CellLink Core startup and shutdown.
...
void CellLinkApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // celllink: URIs or payment requests:
...
int main(int argc, char *argv[])
{
    ...
    Q_INIT_RESOURCE(celllink);
    Q_INIT_RESOURCE(celllink_locale);
    ...
    /// 6. Determine availability of data directory and parse celllink.conf
    ...
    try {
        ...
        QMessageBox::critical(0, QApplication::translate("celllink-core", PACKAGE_NAME), QObject::tr("Error: %1").arg(e.what()));
        return EXIT_FAILURE;
    }
#ifdef ENABLE_WALLET
    ...
    // celllink: links repeatedly have their payment requests routed to this process:
    ...
    try
    {
        ...
        if (CellLinkCore::baseInitialize()) {
            ...
            WinShutdownMonitor::registerShutdownBlockReason(QObject::tr("%1 didn't yet exit safely...").arg(QApplication::translate("celllink-core", PACKAGE_NAME)), (HWND)app.getMainWinId());
#endif
            app.exec();
            app.requestShutdown();
            app.exec();
