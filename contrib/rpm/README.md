...
The RPM spec file provided here is for CellLink-Core 0.12.0 and builds on CentOS
...
[CellLink git repository](https://github.com/bitcoin/bitcoin) but are not part of
...
needed when 0.12.1 is released, a proper fix is already in the CellLink git
master branch.
...
CellLink-Core against OpenSSL or use a patched version of Boost in the build
system.
