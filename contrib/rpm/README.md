...
The RPM spec file provided here is for MagnaChain-Core 0.12.0 and builds on CentOS
...
in the magnachain git repository. At present only an SVG version of the MagnaChain
icon is used.
...
needed when 0.12.1 is released, a proper fix is already in the MagnaChain git
master branch.
...
idea to build MagnaChain Core against a static version of that library compiled
...
MagnaChain-Core against OpenSSL or use a patched version of Boost in the build
system.
...
packaging MagnaChain for Fedora at least since 2012.
