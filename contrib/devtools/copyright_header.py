...
EXPECTED_HOLDER_NAMES = [
    "Satoshi Nakamoto\n",
    "The CellLink Core developers\n",
    "The CellLink Core developers \n",
    "CellLink Core Developers\n",
    "the CellLink Core developers\n",
    "The CellLink developers\n",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The CellLink Core developers'
...
CPP_HEADER = '''
// Copyright (c) %s The CellLink Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The CellLink Core developers'
                 % (filename))
