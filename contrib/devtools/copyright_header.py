...
EXPECTED_HOLDER_NAMES = [
    "Satoshi Nakamoto\n",
    "The MagnaChain Core developers\n",
    "The MagnaChain Core developers \n",
    "MagnaChain Core Developers\n",
    "the MagnaChain Core developers\n",
    "The MagnaChain developers\n",
...
Arguments:
    <base_directory> - The base directory of a magnachain source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The MagnaChain Core developers'
...
CPP_HEADER = '''
// Copyright (c) %s The MagnaChain Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The MagnaChain Core developers'
                 % (filename))
...
Arguments:
    <file> - A source file in the magnachain repository.
"""
