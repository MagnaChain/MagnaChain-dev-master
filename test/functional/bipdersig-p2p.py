...
class BIP66Test(MagnaChainTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # magnachaind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and magnachaind produces more specific reject
            # reasons.
