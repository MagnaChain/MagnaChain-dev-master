...
from test_framework.test_framework import MagnaChainTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (MagnaChainTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that magnachain has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("magnachaind has not been built with zmq enabled.")
