...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MagnaChainTestFramework
    pass

class ExampleTest(MagnaChainTestFramework):
    ...
    def custom_method(self):
        ...
        MagnaChainTestFramework class so other tests can use it."""
