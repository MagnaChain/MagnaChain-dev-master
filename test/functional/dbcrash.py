...
class ChainstateWriteCrashTest(MagnaChainTestFramework):
    def set_test_params(self):
        ...
        # long-running test
        self.base_args = ["-limitdescendantsize=0", "-maxmempool=0", "-rpcservertimeout=900", "-dbbatchsize=200000","-disablesafemode=1"]
    ...
    def restart_node(self, node_index, expected_tip):
        ...
        while time.time() - time_start < 240:
            try:
                ...
                self.log.info('start with args:',self.nodes[node_index].extra_args)
        ...
        # bug in magnachaind, or we've gotten unlucky with our dbcrash ratio --
