...
# TestNode: A peer we use to send messages to magnachaind, and store responses.
...
class CompactBlocksTest(MagnaChainTestFramework):
    ...
    # This test actually causes magnachaind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that magnachaind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for magnachaind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # magnachaind will not send blocktxn responses for blocks whose height is
