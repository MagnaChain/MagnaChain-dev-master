...
class PreciousTest(MagnaChainTestFramework):
    ...
    def run_test(self):
        ...
        bolcks = self.nodes[1].generate(10)
        assert_equal(self.nodes[1].getblockcount(), 10)
        node_sync_via_rpc(self.nodes[0:3])
        assert_equal(self.nodes[0].getbestblockhash(), bolcks[-1])
        ...
        assert_equal(self.nodes[1].getblockcount(), 13)
        assert(hashC != hashG)
