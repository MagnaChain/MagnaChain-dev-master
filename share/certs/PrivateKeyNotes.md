...
unlocked to sign the MagnaChain-Qt.app bundle.
...
allowing somebody to distribute a MagnaChain-Qt.app or magnachain-qt-setup.exe with a valid
...
that the magnachain-qt.exe file inside the installer had not been tampered with.
